...
namespace SystemExplorer.Behaviors {
    public sealed class EventToCommand : Behavior<DependencyObject> {
        ...
        protected override void OnAttached() {
            ...
            if (EventName != null) {
                ...
                if (_event != null) {
                    _handler = Delegate.CreateDelegate(_event.EventHandlerType, this, GetType().GetMethod("OnEvent", BindingFlags.NonPublic | BindingFlags.Instance));
